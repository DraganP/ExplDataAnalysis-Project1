...
globalReactPwr <- as.numeric(d_data$Global_reactive_power)
voltage <- as.numeric(d_data$Voltage)
...
plot(datetime, globalActPwr, type = "l", xlab="", ylab="Global Active Power", cex=0.2)
...
plot(datetime, globalReactPwr, type="l", xlab="datetime", ylab="Global_reactive_power")
